 ...
 * @author leoma
 */
public class TelaAddMusica extends javax.swing.JDialog {
    ...
    public TelaAddMusica(java.awt.Frame parent, boolean modal, ColecaoMusicasPrincipal c) {
        super(parent, modal);
        initComponents();
        colecao = c;
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Tipo de Música");

        tipo.setBackground(new java.awt.Color(102, 102, 102));
        tipo.setForeground(new java.awt.Color(255, 255, 255));
        tipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Canção", "Música Instrumental" }));
        ...
        addBT.setText("ADICIONAR MÚSICA");
    ...
    private void addBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBTActionPerformed
        ...
        if (titulo.isEmpty() || autores.isEmpty() || genero.isEmpty() || jdata.getText().isEmpty() || jduracao.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Preencha todos os campos.");
        } else {
            Object selectedItem = tipo.getSelectedItem();
            if (selectedItem != null) {
                String selectedValue = selectedItem.toString();
                if (selectedValue.equals("Canção")) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAddMusica dialog = new TelaAddMusica(new javax.swing.JFrame(), true, null);
